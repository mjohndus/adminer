...
/**
 * Adminer/Editor wrapper allowing usage of plugins.
 *
 ...
 */
class Pluginer implements AdminerInterface
{
	 ...
	 * @param array|AdminerInterface $config
	 */
	public function __construct(array $plugins, $config = [])
	{
		$this->plugins = $plugins;
		$this->adminer = $config instanceof AdminerInterface ? $config : create_instance($config);
	...
	{
		return $this->adminer->getConfig();
	}

	public function setOperators(?array $operators, ?string $likeOperator, ?string $regexpOperator): void
	{
		$this->adminer->setOperators($operators, $likeOperator, $regexpOperator);
	}

	public function removeOperator(string $operator): void
	{
		$this->adminer->removeOperator($operator);
	}

	public function getOperators(): ?array
	{
		return $this->adminer->getOperators();
	}

	public function getLikeOperator(): ?string
	{
		return $this->adminer->getLikeOperator();
	}

	public function getRegexpOperator(): ?string
	{
		return $this->adminer->getRegexpOperator();
	}
	...
	{
		return call_user_func_array([$this->adminer, $function], $args);
	}
}
