...
Where:
- `<drivers>` is comma separated list of [database drivers](adminer/drivers).
  The default set is: mysql, pgsql, mssql, sqlite.
- `<languages>` is comma separated list of [languages](adminer/lang).
  If not specified, all languages will be included.
- `<themes>` is comma separated list of [themes](adminer/themes).
